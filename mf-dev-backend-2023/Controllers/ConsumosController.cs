...
namespace mf_dev_backend_2023.Controllers
{
    ...
    public class ConsumosController : Controller
    {
        ...
        {
            // O .Include(c => c.Veiculo) faz o "JOIN" com a tabela de veículos
        ...
        {
            // Buscamos todos os veículos e criamos uma lista de seleção
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,Data,Valor,Km,Tipo,VeiculoId")] Consumo consumo)
        {
            ...
            // Se der erro, precisamos recarregar o dropdown
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        // Corrigido para 'Data' (maiúsculo) e 'VeiculoId' (d de dado)
